...
ensure_directory(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'temp'))
ensure_directory(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'logs'))
